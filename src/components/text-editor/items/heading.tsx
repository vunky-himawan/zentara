        ...
        <TextEditorDropdown
            ...
            menu={{
                ...
                items: [
                    {
                        key: "h1",
                        label: <Text style={{ fontSize: 24 }} strong>Heading 1</Text>,
                        onClick: () => onSelect("h1"),
                    },
                    {
                        key: "h2",
                        label: <Text style={{ fontSize: 20 }} strong>Heading 2</Text>,
                        onClick: () => onSelect("h2"),
                    },
                    {
                        key: "h3",
                        label: <Text style={{ fontSize: 16 }} strong>Heading 3</Text>,
                        onClick: () => onSelect("h3"),
                    },
                    {
                        key: "paragraph",
